...
* *"Adicionalmente, el diseño local tiene un propósito **económico fundamental**: evitar generar gastos recurrentes a las instituciones de salud o al usuario final. Mantener una aplicación web de IA en línea requiere el alquiler constante de servidores virtuales potentes y el pago de suscripciones por uso de APIs de modelos comerciales. Al ejecutar todo localmente, el costo operativo continuo es de **cero dólares**."*
* *"Para solventar la necesidad de comprobar el funcionamiento del software, hemos provisto un video detallado en el repositorio de GitHub donde se demuestra la ejecución en tiempo real del sistema local, asegurando la reproducibilidad de la investigación sin sacrificar la privacidad de los datos médicos ni incurrir en costos de nube."*
