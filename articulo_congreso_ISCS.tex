...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\columnwidth]{fig1_architecture.png}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.9\linewidth]{fig3_interface.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\columnwidth]{fig2_results.png}
