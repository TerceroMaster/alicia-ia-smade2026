...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\columnwidth]{pictures/architecture_diagram_1782154710548.png}
  \caption{High-level pipeline and air-gapped system architecture of AlicIA Pharmaceutical.
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=1\linewidth]{pictures/fig3_interface_english.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\columnwidth]{pictures/fig2_results.png}
